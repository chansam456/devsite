    ...
    return(
        <div>
            <div className='left-panel'>
                <h1>About</h1>
                <p>I'm a full-stack developer who is never afraid to go back to the drawing board, 
            ...
            <div className='right-panel'>[Right panel contains a picture which should stay until this page passes when scrolling]</div>
        </div>
    );
}
